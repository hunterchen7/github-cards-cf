// Language alias translation, ported verbatim from github-profile-summary-cards.
// Maps Linguist aliases (js -> JavaScript, cs -> C#, ...) to canonical names so a
// user's `exclude` list matches GitHub's language names.
// https://github.com/github/linguist/blob/master/lib/linguist/languages.yml

export function translateLanguage(lang: string): string {
...
// Normalize a comma-separated EXCLUDE list into lowercase canonical language
// names, matching the lowercase comparison used by the language-card filters.
export function parseExcludeLanguages(input: string): string[] {
  return input
    .split(',')
    .map((val) => val.trim())
